 ...
 * {@link tickGeometraThreeWebGLWithSceneBasicsFrame} (`onFrame` may return `false` to skip `render`, or throw to skip), {@link disposeGeometraThreeWebGLWithSceneBasics},
