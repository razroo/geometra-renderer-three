...
#     resizeTickGeometraThreeWebGLWithSceneBasics / resizeTickGeometraThreeWebGLWithSceneBasicsDrawingBuffer / resizeTickGeometraThreeWebGLWithSceneBasicsDrawingBufferHeadless / resizeTickGeometraThreeWebGLWithSceneBasicsFromPlainViewSizing / resizeTickGeometraThreeWebGLWithSceneBasicsFromPlainHostSnapshot / resizeTickGeometraThreeWebGLWithSceneBasicsHeadless (resize then tick; drawing-buffer pair uses resizeGeometraThreeDrawingBufferView / Headless + tick; plain-sizing variant matches sequential resize-from-plain + tick; plain-host-snapshot delegates to plain-sizing; headless setSize-path variant delegates with raw DPR 1; same as sequential resize + tickGeometraThreeWebGLWithSceneBasicsFrame) /
